...
=head1 DESCRIPTION
 ...
 Representation of a reporter. A reporter is what is being used/measured
 to produce the experiment's outcome, e.g. an antibody against a protein.
...
=head2 new
 ...
 Arg: (optional) hash
 Description: Creates a new Reporter object. If given a hash, will set the
              corresponding attributes.
 Returntype: Reporter object
...
=head2 ID
 ...
 Arg: (optional) string
 Description: Gets/sets reporter ID, e.g. a siRNA ID or a compound ChEBI ID
 Returntype: string
...
=head2 type
 ...
 Arg: (optional) string
 Description: Gets/sets reporter type, e.g. dsRNA, drug...
 Returntype: string
