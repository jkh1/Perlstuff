...
print STDERR "Class: ",$class->idx," ",$class->label," ",$class->name," ",$class->color," p= ",$object->class_probability,"\n";
...
print STDERR "Class: ",$class->idx," ",$class->label," ",$class->name," ",$class->color," p= ",$parent->class_probability,"\n";
...
print STDERR "Class: ",$class->idx," ",$class->label," ",$class->name," ",$class->color," p= ",$child->class_probability,"\n";
$img = $child->get_image();
$img->pgm("child.pgm");
